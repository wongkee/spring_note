...
public class DynamicProxyTest {
    public static void main(String[] args){
       ...
       //产生一个代理对象
       SellWine obj=(SellWine) new GuitaiA().getInstance(new MaotaiJiu());
       System.out.println(obj.getClass());
       obj.mainJiu();

        SellWine obj1=(SellWine) new GuitaiA().getInstance(new Xifengjiu());
        obj1.mainJiu();
       /*
        * 实现原理
        * 1、拿到被代理对象的引用，然后获取它的接口   （代理对象时可以强制转换成这个接口的）
